...
#ifndef BIOMOLECULES_SPRELAY_CORE_IMPL_SERIAL_PORT_UTILS_TEST_H_
#define BIOMOLECULES_SPRELAY_CORE_IMPL_SERIAL_PORT_UTILS_TEST_H_
...
#endif  // BIOMOLECULES_SPRELAY_CORE_IMPL_SERIAL_PORT_UTILS_TEST_H_
